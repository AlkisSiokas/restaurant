  ...
  <div className="app__footer section__padding" id="login">
    ...
    <div className="app__footer-links">
      <div className="app__footer-links_contact">
        ...
        <p className="p__opensans" style={{ color: '#AAAAAA' , marginBottom: '1rem'}}>9 W 53rd St, New York, NY 10019, USA</p>
      ...
      <div className="app__footer-links_work">
        ...
        <p className="p__opensans" style={{ color: '#AAAAAA' }}>07:00 am - 11:00 pm</p>
